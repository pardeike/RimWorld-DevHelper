...
namespace DevHelper
{
	public static class NativeMethods
	{
		...
		public delegate bool EnumChildWindowsNativeCallback(IntPtr hWnd, IntPtr lParam);

		[DllImport("user32.dll")]
		public static extern bool EnumChildWindows(IntPtr hwndParent, EnumChildWindowsNativeCallback lpEnumFunc, IntPtr lParam);
